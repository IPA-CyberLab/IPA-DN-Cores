...
namespace IPA.Cores.Helper.Basic
{
    static class BasicHelper
    {
        ...
        public static string TryGetContentsType(this IPA.Cores.Basic.HttpClientCore.HttpContentHeaders h) => (h == null ? "" : h.ContentType == null ? "" : h.ContentType.ToString().NonNull());
