...
namespace IPA.Cores.Codes.DnsTools
{
    ...
    public class DaneStream : AuthenticatedStream
	{
		...
		/// </param>
		public void AuthenticateAsClient(string targetHost, int port, ProtocolType protocol = ProtocolType.Tcp, X509CertificateCollection clientCertificates = null, SslProtocols enabledSslProtocols = IPA.Cores.Basic.CoresConfig.SslSettings.DefaultSslProtocolVersionsConst, bool checkCertificateRevocation = false)
		{
		...
		///   checked during authentication.
		/// </param>
		public async Task AuthenticateAsClientAsync(string targetHost, int port, ProtocolType protocol = ProtocolType.Tcp, X509CertificateCollection clientCertificates = null, SslProtocols enabledSslProtocols = IPA.Cores.Basic.CoresConfig.SslSettings.DefaultSslProtocolVersionsConst, bool checkCertificateRevocation = false)
		{
