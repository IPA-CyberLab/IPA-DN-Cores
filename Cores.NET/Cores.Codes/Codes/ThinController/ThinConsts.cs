...
namespace IPA.Cores.Codes
{
    public static partial class ThinControllerConsts
    {
        ...
        public static readonly Copenhagen<string> Default_DbConnectionString_Read = "Data Source=127.0.0.1;Initial Catalog=THINDB;Persist Security Info=True;User ID=sql_thin_reader;Password=sql_password;";
        public static readonly Copenhagen<string> Default_DbConnectionString_Write = "Data Source=127.0.0.1;Initial Catalog=THINDB;Persist Security Info=True;User ID=sql_thin_writer;Password=sql_password;";
