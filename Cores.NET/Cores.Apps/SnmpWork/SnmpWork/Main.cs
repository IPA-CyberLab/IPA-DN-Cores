...
namespace IPA.SnmpWork
{
    class SnmpWorkAppMain
    {
        ...
        [ConsoleCommand(
            "IPA.Cores SnmpWork Program",
            "[/IN:infile] [/OUT:outfile] [/CSV] [/CMD command_line...]",
            "This is the SnmpWork Program.",
        ...
        static int SnmpWork(ConsoleService c, string cmdName, string str)
        {
            ...
            while (cs.DispatchCommand(cmdline, "SnmpWork>", typeof(SnmpWorkCommands), null))
            {
